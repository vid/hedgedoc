...
export class NotesController {
  ...
  async deleteNote(@Request() req, @Param('noteIdOrAlias') noteIdOrAlias: string) {
  ...
  async getNoteContent(@Request() req, @Param('noteIdOrAlias') noteIdOrAlias: string) {
  ...
  async getNoteMetadata(@Request() req, @Param('noteIdOrAlias') noteIdOrAlias: string) {
  ...
  async getNoteRevisions(@Request() req, @Param('noteIdOrAlias') noteIdOrAlias: string) {
