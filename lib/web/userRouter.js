...
const { meNotes, meNoteSearch } = require('mdld/lib/hedgedoc/server').routes({errors, models, logger});

const UserRouter = module.exports = Router()

UserRouter.get('/me/notes/search/:search', (req, res) => meNoteSearch(req, res, req.params.search))
UserRouter.get('/me/notes', meNotes)
